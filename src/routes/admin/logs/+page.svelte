    ...
    <div class="filter-panel">
      ...
      <div class="filter-grid">
        ...
        <label class="filter-field full">
          <span>Search</span>
          <input type="text" placeholder="Search message or data..." bind:value={filterForm.search} />
        </label>
      </div>
      ...
      <div class="filter-actions">
        ...
        <button class="cancel-btn" onclick={() => (showFilters = false)}>
          Cancel
        </button>
      </div>
    </div>
        ...
        <div class="critical-list">
          ...
          {:else}
            {#each criticalLogs as error (error.id)}
              <button
                class="critical-card"
                onclick={() => (selectedClientError = error)}
              >
                ...
                <div class="critical-actions">
                  <span
                    ...
                    role="button"
                    tabindex="0"
                    onclick={(e) => { e.stopPropagation(); handleCopyClientError(error); }}
                    onkeydown={(e) => { if (e.key === 'Enter') { e.stopPropagation(); handleCopyClientError(error); }}}
                  >
  ...
  <div class="modal-backdrop" onclick={() => (selectedLog = null)}>
    <div class="modal-content" onclick={(e) => e.stopPropagation()}>
      <div class="modal-header">
        ...
        <button class="close-btn" onclick={() => (selectedLog = null)}>
          <i class='bx bx-x'></i>
        </button>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button class="btn" onclick={() => (selectedLog = null)}>
          Close
        </button>
      </div>
    </div>
...
{#if selectedClientError}
  <div class="modal-backdrop" onclick={() => (selectedClientError = null)}>
    <div class="modal-content" onclick={(e) => e.stopPropagation()}>
      <div class="modal-header error">
        ...
        <button class="close-btn" onclick={() => (selectedClientError = null)}>
          <i class='bx bx-x'></i>
        </button>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button class="btn" onclick={() => (selectedClientError = null)}>
          Close
        </button>
      </div>
    </div>
