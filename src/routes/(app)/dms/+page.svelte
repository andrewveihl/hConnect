...
>
	<div class="hidden md:block md:w-80 h-full">
	...
	<div class="flex flex-1 flex-col panel dm-placeholder">
		<header class="channel-header">
			...
			<div class="hidden sm:block text-xs text-soft">Pick a friend to start chatting.</div>
		</header>
		...
		<main class="flex-1 panel-muted flex items-center justify-center text-soft p-6">
			<div class="text-center max-w-md space-y-2">
				...
				<p>
					Choose someone from your message list to begin chatting. Swipe right or tap the menu to
					open conversations on mobile.
				</p>
			</div>
		</main>
	</div>
