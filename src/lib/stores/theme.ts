...
const HOLIDAY_TONE: Record<HolidayThemeId, 'light' | 'dark'> = [
	...HOLIDAY_SCHEDULE,
...
if (browser) {
	...
	if ('addEventListener' in media) {
		...
		(media as MediaQueryList).addListener(
			handleMedia as (this: MediaQueryList, ev: MediaQueryListEvent) => void
		);
	}
