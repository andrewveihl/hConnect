<script lang="ts">
	...
	function handleDevicesSaved(event: {
...
>
	...
	<!-- ─────────────────────────────────────────────────────────────────────── -->
	<header
		class="voice-panel__header flex items-center gap-3 px-4 py-3 border-b border-[color:var(--color-border-subtle)]"
	>
		...
		<div class="flex items-center gap-1 px-2 py-1 rounded-full bg-[color:var(--color-panel-muted)]">
			...
			<span class="text-xs font-medium text-[color:var(--color-text-primary)]"
	...
	{#if $showReconnectButton}
		<div
			class="voice-panel__reconnect flex items-center justify-between gap-3 px-4 py-2 bg-rose-500/10 border-b border-rose-500/20"
		>
	...
	<!-- ─────────────────────────────────────────────────────────────────────── -->
	<div
		class="voice-panel__members flex-1 overflow-y-auto px-2 py-3"
		role="list"
	...
	>
		{#if $participants.length === 0}
			<div class="flex flex-col items-center justify-center h-full text-center px-4 py-8">
				<div
					class="w-16 h-16 rounded-full bg-[color:var(--color-panel-muted)] flex items-center justify-center mb-4"
				>
					...
					>
						...
						<div class="relative flex-shrink-0">
							...
							{#if participant.isMuted || participant.serverMuted}
								<div
									class="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-rose-500 flex items-center justify-center ring-2 ring-[color:var(--color-sidebar)]"
								>
						...
						<div class="flex-1 min-w-0">
							<div class="flex items-center gap-2">
								...
								{#if participant.screenSharing}
									<span
										class="px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-rose-200 bg-rose-500/20 rounded"
									>
										Live
									</span>
								{/if}
	...
	<!-- ─────────────────────────────────────────────────────────────────────── -->
	<div
		class="voice-panel__controls border-t border-[color:var(--color-border-subtle)] bg-[color:var(--color-panel)] px-3 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))]"
	>
