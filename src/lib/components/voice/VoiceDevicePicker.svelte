...
{#if open}
	...
	>
		<!-- Modal -->
		<div
			class="w-full max-w-lg rounded-xl bg-[color:var(--color-panel)] border border-[color:var(--color-border-subtle)] shadow-2xl overflow-hidden"
		>
			<!-- Header -->
			<header
				class="flex items-center justify-between px-5 py-4 border-b border-[color:var(--color-border-subtle)]"
			>
				<h2
			...
			<div class="p-5 space-y-6 max-h-[60vh] overflow-y-auto">
				{#if loading}
					<div class="flex items-center justify-center py-8">
						<i
							class="bx bx-loader-alt text-3xl text-[color:var(--color-text-secondary)] animate-spin"
						></i>
					</div>
				{:else if error}
				...
				{:else}
					...
					<div class="space-y-3">
						<label
							for="mic-select"
							class="flex items-center gap-2 text-sm font-medium text-[color:var(--color-text-primary)]"
						>
						...
						<div class="flex items-center gap-3">
							...
							<div
								class="flex-1 h-2 rounded-full bg-[color:var(--color-panel-muted)] overflow-hidden"
							>
								<div
					...
					<div class="space-y-3">
						...
						<div class="relative aspect-video rounded-lg bg-black overflow-hidden">
							<video bind:this={videoEl} class="w-full h-full object-cover" muted playsinline
							></video>
							{#if !videoPreviewStream}
			...
			<!-- Footer -->
			<footer
				class="flex items-center justify-end gap-3 px-5 py-4 border-t border-[color:var(--color-border-subtle)] bg-[color:var(--color-panel-muted)]/50"
			>
				<button
					onclick={handleClose}
