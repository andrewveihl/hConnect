...
<div
	class="hidden lg:flex lg:flex-col w-64 bg-gray-800 border-l border-gray-700 flex-shrink-0 overflow-hidden"
>
	<!-- Header -->
			...
			<div class="px-4 py-3">
				...
				<div class="space-y-2">
					{#each getOnlineUsers() as member (member.id)}
						...
						>
							<div
								class="relative flex-shrink-0 w-8 h-8 rounded-full overflow-visible aspect-square bg-gray-700 border border-gray-600"
							>
			...
			<div class="px-4 py-3">
				...
				<div class="space-y-2">
					{#each getOfflineUsers() as member (member.id)}
						...
						>
							<div
								class="relative flex-shrink-0 w-8 h-8 rounded-full overflow-visible aspect-square bg-gray-700 border border-gray-600 opacity-60"
							>
								<div class="w-full h-full rounded-full overflow-hidden">
									<img
										src={resolveProfilePhotoURL(member)}
