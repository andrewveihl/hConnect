...
{#if isStaff}
  ...
  {#if expanded}
    <div class="ticket-backdrop" onclick={handleBackdropClick}></div>
  {/if}
...
<style>
  ...
  @keyframes ticket-pulse {
    0%, 100% { box-shadow: 0 14px 26px rgba(249, 115, 22, 0.32); }
    50% { box-shadow: 0 14px 32px rgba(249, 115, 22, 0.5); }
  }
