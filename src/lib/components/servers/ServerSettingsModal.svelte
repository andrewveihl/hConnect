      ...
      <div class="server-settings-modal__body">
        ...
        <aside class="server-settings-modal__sidebar">
            ...
            {#each groupedSections as group}
              <div class="server-settings-modal__nav-group">
                ...
                {#each group.items as section (section.id)}
                  ...
                  >
                    <i class="bx {sectionIcons[section.id] ?? 'bx-cog'} server-settings-modal__nav-icon" aria-hidden="true"></i>
          ...
          <div class="server-settings-modal__sidebar-footer">
            <button type="button" class="server-settings-modal__quick-action" onclick={requestClose}>
        ...
        <section class="server-settings-modal__content">
          <ServerSettingsPanel serverId={serverId} section={mapServerSectionToPanel(activeSection)} {featureModal} bare />
        </section>
      </div>
    </div>
  </div>
