    ...
    >
      ...
      >
        <header class="flex h-14 items-center gap-2 border-b border-[color:var(--color-border-subtle)] bg-[color:var(--surface-root)] px-4">
          ...
          <div class="flex-1">
            <p class="text-sm font-semibold text-[color:var(--color-text-primary)]">Server Settings</p>
          </div>
          <div class="flex h-9 w-9 items-center justify-center rounded-full border border-[color:var(--color-border-subtle)] bg-[color:var(--color-panel-muted)] text-[color:var(--text-70)]">
          ...
          <header class="flex h-14 items-center gap-2 border-b border-[color:var(--color-border-subtle)] px-4">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm font-semibold text-[color:var(--color-text-primary)]">
                {serverSettingsSections.find((section) => section.id === detailSection)?.label ?? 'Section'}
              </p>
            </div>
          </header>
